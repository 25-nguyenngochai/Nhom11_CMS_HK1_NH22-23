...
if ( ! class_exists( 'Multivendor_Marketplace_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Multivendor_Marketplace_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Multivendor_Marketplace_WPTT_WebFont_Loader( $url );
